package se.ithuset.eventsourcing.producer.service;
...
import se.ithuset.eventsourcing.producer.sender.EventSender;

@Service
public class EventService {
    private EventSender producer;
    ...
    @Autowired
    public EventService(EventSender producer, ObjectMapper objectMapper, RestTemplate restTemplate) {
